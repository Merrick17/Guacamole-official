  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className=" uppercase h-8 max-w-[130px] absolute z-20 text-center w-[90%] px-5 py-1 bottom-2 left-1/2 -translate-x-1/2 bg-black text-white rounded-[5px] font-semibold text-sm transition-opacity duration-200 ease-in-out">
          {children}
        </div>
      </div>
    </div>
