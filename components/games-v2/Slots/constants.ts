...
export const SLOT_ITEMS = [
  slotItem(7, IMAGE_UNICORN.src),
  slotItem(5, IMAGE_5X.src),
  slotItem(3, IMAGE_3X.src),
  slotItem(2, IMAGE_2X.src),
  slotItem(1, IMAGE_COOL.src, IMAGE_HEARTS.src),
  slotItem(.5, IMAGE_WOJAK.src),
].flat()
