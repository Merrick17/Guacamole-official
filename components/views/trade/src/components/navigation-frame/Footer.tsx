...
const Footer = () => {
  return (
    <footer className="footer footer-center bg-gradient-to-r from-green-400 to-blue-500 p-10 text-primary-content">
      <div>
      ...
      <div>
        <div className="grid-col grid gap-4 font-bold sm:grid-flow-col">
          {ITEMS.map((e, idx) => (
