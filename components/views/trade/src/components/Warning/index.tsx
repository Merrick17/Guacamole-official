      ...
      <div className="text-sm font-bold">
        ...
        <div className="mt-5 flex flex-row items-center">
          <input
            ...
            type="checkbox"
            checked={checked}
            className="checkbox-accent checkbox mr-5"
          />
        ...
        <div>
          <ButtonBorderGradient
            ...
            onClick={handle}
            containerClass="my-2"
            buttonClass="bg-[#E5E7EB] w-full p-2 uppercase font-bold h-[50px]"
            fromColor="green-400"
            toColor="blue-500"
          >
            Enter
          ...
          <button
            ...
            className="h-[50px] w-full rounded-[10px] bg-black p-[2px] font-bold uppercase"
          >
            Leave
          </button>
        </div>
