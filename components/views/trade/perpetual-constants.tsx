...
export const GroupPubkeyMap = new Map<number, Group>([
  ...
  [
    ...
    {
      productsIndex: 1,
      pubkey: "4cKB5xKtDpv4xo6ZxyiEvtyX3HgXzyJUS1Y8hAfoNkMT",
      name: "BlueChip",
    },
  ],
]);
    ...
    new Map<string | number, Product>([
      [
        "BTCUSD-PERP",
        {
          ...
          base: "BTC",
          quote: "USDC",
          baseLogo: "https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/9n4nbM75f5Ui33ZbPYXn59EwSgE8CGsHtAeTH5YFeJ9E/logo.png",
          quoteLogo: "/icons/earn/usd-coin-usdc-logo.svg",
          mapType: "str",
        },
      ],
      [
        "ETHUSD-PERP",
        {
          ...
          base: "ETH",
          quote: "USDC",
          baseLogo: "/images/tokens/ETH.png",
          quoteLogo: "/icons/earn/usd-coin-usdc-logo.svg",
          mapType: "str",
        },
      ],
      [
        "SOLUSD-PERP",
        {
          ...
          base: "SOL",
          quote: "USDC",
          baseLogo: "/images/tokens/SOL.png",
          quoteLogo: "/icons/earn/usd-coin-usdc-logo.svg",
          mapType: "str",
        },
      ],
      [
        0,
        {
          ...
          base: "BTC",
          quote: "USDC",
          baseLogo: "/static/coins/bitcoin.png",
          quoteLogo: "/icons/earn/usd-coin-usdc-logo.svg",
          mapType: "num",
        },
      ],
