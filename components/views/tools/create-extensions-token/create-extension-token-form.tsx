...
const CreateExtensionTokenForm: FC<CreateExtensionTokenFormProps> = () => {
  ...
  const [isDefaultAccountState, setIsDefaultAccountState] =
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3 pb-6">
        ...
        {isTax && (
          <>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="border-[1px] border-[rgba(168, 168, 168, 0.10)]">
                  ...
                  <FormControl>
                    <Input placeholder="Withdraw Authority" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="border-[1px] border-[rgba(168, 168, 168, 0.10)]">
                  <FormLabel className="uppercase">Config Authority*</FormLabel>
                  <FormControl>
                    <Input placeholder="Config Authority" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
        ...
        {/* <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={() => setIsInterestBearing((s) => !s)}
          />
          <label
            htmlFor="interest"
            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            id="default"
            checked={isDefaultAccountState}
            onCheckedChange={() => setIsDefaultAccountState((s) => !s)}
          />
          <label
            htmlFor="default"
            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
        ...
        {/* <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={() => setIsPermanentDelegate((s) => !s)}
          />
          <label
            htmlFor="delegate"
            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={() => setIsNonTransferable((s) => !s)}
          />
          <label
            htmlFor="transfer"
            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
...
export default CreateExtensionTokenForm;
