...
interface PlaySlotsCardComponentProps
  extends React.HTMLAttributes<HTMLDivElement> {}

const PlaySlotsCardComponent: FunctionComponent<PlaySlotsCardComponentProps> = ({
  className,
...
export default PlaySlotsCardComponent;
